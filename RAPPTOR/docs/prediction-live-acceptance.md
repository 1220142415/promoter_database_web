...
2. `genome_scan`: the entire reference, stride 1, both strands; exactly **2 × (4,641,652 − 100 + 1) = 9,283,106 windows**. Request BigWig and Parquet to retain every window without a huge unfiltered GFF3 export.
