...
class ModelRuntime:
    ...
    def score_sequence(self, sequence: str, cgr_tensor: torch.Tensor | None, *, stride: int, batch_size: int, progress_callback=None) -> np.ndarray:
        ...
        return run_inference_on_sequence(sequence, self.model, cgr_tensor, args, progress_callback=progress_callback)
