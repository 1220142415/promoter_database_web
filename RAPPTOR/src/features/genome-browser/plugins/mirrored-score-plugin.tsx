...
function isMirroredScoreDisplay(model: object) {
  try {
    ...
    const metadata = getConf(track, 'metadata') as { rapptorMirroredScore?: unknown };
    return metadata.rapptorMirroredScore === true;
  } catch {
    return false;
  }
}
...
const rendererConfig = ConfigurationSchema('RAPPTORMirroredScoreRendererConfig', {}, { explicitlyTyped: true });

export default class RapptorMirroredScorePlugin extends Plugin {
  name = 'RAPPTORMirroredScorePlugin';
