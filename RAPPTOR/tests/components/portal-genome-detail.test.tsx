...
import type { GenomeCatalogDetails, GenomeCatalogMatch } from '@/features/genomes/types';
...
function details(): GenomeCatalogDetails {
  return {
    ...
    release: {
      ...
      datasetVersion: 'RAPPTOR 2026-08-13',
...
describe('genome detail release contract', () => {
  ...
  it('shows the NCBI track contract without a duplicate release download list', async () => {
    ...
    expect(screen.getByLabelText('Genome files')).toHaveTextContent('ReferenceAvailablePromoter predictionsAvailableAnnotationAvailable');
