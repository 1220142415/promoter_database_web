...
def parse_args():
    parser = argparse.ArgumentParser(description='Create and upload the SeqEdge Hugging Face Dataset pilot.')
...
def main():
    ...
    api.upload_folder(
        ...
        repo_id=args.repo,
        repo_type='dataset',
        commit_message=f'Add SeqEdge {args.release} two-genome storage pilot',
    )
