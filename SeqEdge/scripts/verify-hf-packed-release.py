...
"""Verify a packed SeqEdge release against Hugging Face repository metadata.
...
_UPLOAD_SPEC = importlib.util.spec_from_file_location('seqedge_upload_hf_packed_release', _UPLOAD_MODULE_PATH)
...
def parse_args():
    parser = argparse.ArgumentParser(description='Verify all physical objects in a packed SeqEdge Hugging Face release.')
