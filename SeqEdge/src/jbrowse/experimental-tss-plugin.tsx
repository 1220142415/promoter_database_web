...
import { ExperimentalTssRendering, experimentalTssCoordinate } from '@/jbrowse/experimental-tss-renderer';
import { strandLabel } from '@/jbrowse/strand-feature-renderer';

export const EXPERIMENTAL_TSS_RENDERER = 'SeqEdgeExperimentalTssRenderer';
...
function isExperimentalDisplay(model: object) {
  try {
    ...
    const metadata = getConf(track, 'metadata') as { seqEdgeEvidenceType?: unknown };
    return metadata.seqEdgeEvidenceType === 'experimental_tss';
  } catch {
    return false;
  }
}
...
export default class SeqEdgeExperimentalTssPlugin extends Plugin {
  name = 'SeqEdgeExperimentalTssPlugin';
